...
def get_location(destination):
    ...
    center_lon, center_lat = 127.08320942869801,37.23995265963222 #currentgps.get_gps()##  #currentgps.get_gps()
...
def get_location(destination):
    ...
    center_lon, center_lat = 127.08320942869801,37.23995265963222#aigo_call_coord()##  #currentgps.get_gps()
    print(center_lon, center_lat)
    tmap_location_url = "https://apis.openapi.sk.com/tmap/pois?version=1&format=json&callback=result"
